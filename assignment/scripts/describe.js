...
// We create a variable called Dane. The code below checks to see if our variable 'Dane' matches exactly in form to Mary.
// Dane does not match in string or number exactly to Mary.
...
// FIX - colorOne and colorTwo have the colors swapped. The solution is to change one to blue and two to red. We are also missing that when mix is true, colorTwo will also be purple.
// We will add into the second statement after colorOne, colorTwo = 'purple';
/*
let colorOne = 'red';
let colorTwo = 'blue';
let mix = true;
...
// FIX - Everything is correct in this code however we have OR || where AND && should be.
// To correct this we need to change it to &&. After correction, console.log ('throw away the food!');
...
//FIX - In order for the below code to match the above description we have to change age and minAge around and then have it be >= instead of <=.
//After this change, we console.log('enter');
/*
let age = 21;
const minAge = 21;
